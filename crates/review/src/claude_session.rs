...
fn extract_project_name(dir_name: &str) -> String {
    ...
    // "-private-var-folders-m1-9q-ct1913z10v6wbnv54j25r0000gn-T-vibe-ultra-worktrees-a04a-store-payloads-i"
...
mod tests {
    ...
    fn test_extract_project_name() {
        ...
        assert_eq!(
            extract_project_name(
                "-private-var-folders-m1-9q-ct1913z10v6wbnv54j25r0000gn-T-vibe-ultra-worktrees-1ff1-new-rust-binary"
            ),
            "new-rust-binary"
        );
    }

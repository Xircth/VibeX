...
## Authentication
Authenticate and configure CCR outside of Vibe Ultra. Follow the instructions on the CCR GitHub repo:
...
## Configure Vibe Ultra

Vibe Ultra does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Vibe Ultra

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Vibe Ultra" />
</Frame>

## Using CCR in Vibe Ultra

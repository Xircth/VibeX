...
icon: https://www.vibex.com/images/logos/claude.svg#"
---
...
## Authentication
Authenticate and configure CCR outside of VibeX. Follow the instructions on the CCR GitHub repo:
...
VibeX does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in VibeX

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in VibeX" />
</Frame>

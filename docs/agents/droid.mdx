...
icon: https://www.vibeultra.com/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in Vibe Ultra, you must first authenticate:
...
Droid supports several configuration options in Vibe Ultra:
...
These options can be configured when creating agent configurations in Vibe Ultra.

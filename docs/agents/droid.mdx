...
icon: https://www.vibex.com/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in VibeX, you must first authenticate:
...
Droid supports several configuration options in VibeX:
...
These options can be configured when creating agent configurations in VibeX.

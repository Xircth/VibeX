...
icon: https://www.vibeultra.com/images/logos/openai-logo.svg
---
...
By default, Codex stores its configuration and session data in `~/.codex`. If you have configured a custom location using the `CODEX_HOME` environment variable, Vibe Ultra will automatically detect and use that location.

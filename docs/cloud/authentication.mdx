...
VibeX Cloud uses OAuth authentication, allowing you to sign in with your existing GitHub or Google account instead of creating a new password.
...
OAuth is a secure way to sign in to applications using accounts you already have. When you click "Sign in with GitHub", you're redirected to GitHub to confirm you want to allow VibeX access. GitHub then tells VibeX who you are, without VibeX ever seeing your GitHub password.
</Info>
...
<Step title="Authorise on Provider">
  ...
  Click **Authorize** (GitHub) or **Allow** (Google) to grant VibeX access.
</Step>

<Step title="Redirected Back">
  After authorising, you're automatically redirected back to VibeX and signed in.
</Step>
</Steps>

### What VibeX Can Access

When you authorise VibeX, it only requests minimal permissions:
...
2. Find "VibeX Cloud" and revoke access
...
3. Sign out there
4. Return to VibeX and sign in - you'll be prompted to log in to the provider

## Security Best Practices

<CardGroup cols={2}>
<Card title="Use a strong provider password" icon="lock">
  Your VibeX security depends on your GitHub/Google account security. Use a strong, unique password.
</Card>
...
2. If you're part of a GitHub organisation with app restrictions, ask your admin to approve VibeX
</Accordion>
...
**Problem:** You revoked VibeX's access on GitHub/Google and now can't sign in.

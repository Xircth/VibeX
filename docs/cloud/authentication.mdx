...
Vibe Ultra Cloud uses OAuth authentication, allowing you to sign in with your existing GitHub or Google account instead of creating a new password.
...
OAuth is a secure way to sign in to applications using accounts you already have. When you click "Sign in with GitHub", you're redirected to GitHub to confirm you want to allow Vibe Ultra access. GitHub then tells Vibe Ultra who you are, without Vibe Ultra ever seeing your GitHub password.
</Info>
...
<Step title="Authorise on Provider">
  ...
  Click **Authorize** (GitHub) or **Allow** (Google) to grant Vibe Ultra access.
</Step>

<Step title="Redirected Back">
  After authorising, you're automatically redirected back to Vibe Ultra and signed in.
</Step>
</Steps>

### What Vibe Ultra Can Access

When you authorise Vibe Ultra, it only requests minimal permissions:
...
2. Find "Vibe Ultra Cloud" and revoke access
...
1. Sign out of Vibe Ultra
2. Go to the provider's website (github.com or google.com)
3. Sign out there
4. Return to Vibe Ultra and sign in - you'll be prompted to log in to the provider

## Security Best Practices

<CardGroup cols={2}>
<Card title="Use a strong provider password" icon="lock">
  Your Vibe Ultra security depends on your GitHub/Google account security. Use a strong, unique password.
</Card>
...
2. If you're part of a GitHub organisation with app restrictions, ask your admin to approve Vibe Ultra
</Accordion>
...
4. Return to Vibe Ultra and sign in
</Accordion>
...
**Problem:** You revoked Vibe Ultra's access on GitHub/Google and now can't sign in.

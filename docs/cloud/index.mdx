...
<Note>
VibeX Cloud is currently in <Badge color="orange">Beta</Badge>. Features may change before stable release.
</Note>

## What is VibeX Cloud?

**VibeX Cloud** adds team collaboration to VibeX. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same VibeX interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same VibeX installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run VibeX** as usual with `npx vibex`
...
Think of it as your company or team in VibeX.
...
- Review code directly in VibeX
- Track PR status

## Getting Started

<Steps>
<Step title="Run VibeX">
  ```bash
  npx vibex
  ```
</Step>

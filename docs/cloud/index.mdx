---
title: "Vibe Ultra Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

<Note>
Vibe Ultra Cloud is currently in <Badge color="orange">Beta</Badge>. Features may change before stable release.
</Note>

## What is Vibe Ultra Cloud?

**Vibe Ultra Cloud** adds team collaboration to Vibe Ultra. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Vibe Ultra interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Vibe Ultra installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Vibe Ultra** as usual with `npx vibe-ultra`
...
Think of it as your company or team in Vibe Ultra.
...
- Review code directly in Vibe Ultra
- Track PR status

## Getting Started

<Steps>
<Step title="Run Vibe Ultra">
  ```bash
  npx vibe-ultra
  ```
</Step>

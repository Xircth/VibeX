...
description: "Solutions for common issues with Vibe Ultra Cloud"
---

This page covers common issues you might encounter with Vibe Ultra Cloud and how to resolve them.
...
4. Return to Vibe Ultra and sign in again
</Accordion>
...
3. Try a different browser
4. Restart Vibe Ultra (`npx vibe-ultra`)
</Accordion>
...
1. **Check existing issues:** [github.com/vibe-ultra/vibe-ultra/issues](https://github.com/vibe-ultra/vibe-ultra/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/vibe-ultra/vibe-ultra/issues/new">

...
<Info>
Agent profiles are used throughout VibeX wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. VibeX saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within VibeX for your coding agents
</Card>

<Card title="VibeX MCP Server" icon="plug" href="/integrations/vibex-mcp-server">
  Connect external MCP clients to VibeX's MCP server
</Card>
</CardGroup>

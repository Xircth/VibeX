...
<Info>
Agent profiles are used throughout Vibe Ultra wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Vibe Ultra saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Vibe Ultra for your coding agents
</Card>

<Card title="Vibe Ultra MCP Server" icon="plug" href="/integrations/vibe-ultra-mcp-server">
  Connect external MCP clients to Vibe Ultra's MCP server
</Card>
</CardGroup>

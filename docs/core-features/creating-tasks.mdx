...
<Tip>
For detailed setup instructions and examples, see the [VibeX MCP Server](/integrations/vibex-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your VibeX project based on this description.

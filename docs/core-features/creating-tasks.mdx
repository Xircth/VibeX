...
<Tip>
For detailed setup instructions and examples, see the [Vibe Ultra MCP Server](/integrations/vibe-ultra-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Vibe Ultra project based on this description.

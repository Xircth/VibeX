...
Preview Mode provides an embedded browser experience within VibeX, allowing you to test and iterate on your web applications without leaving the development environment. This feature eliminates the need to switch between your browser and VibeX by providing live preview capabilities and precise component selection tools.

**Key Benefits:**
- **Embedded viewing**: See your application running directly in VibeX
...
<Step title="Install Web Companion">
  For precise component selection, install the `vibex-web-companion` package in your application.

  <Info>
  **Recommended**: Use the "Install companion automatically" button in the Preview tab to have VibeX create a task that installs and configures the companion for you.
  ...
  **Manual Installation:**
  ...
  ```bash
  npm install vibex-web-companion
  ```
...
3. **Interact with your app** directly within VibeX
...
<Step title="Activate Selection Mode">
  Click the floating VibeX companion button in the bottom-right corner of your application to activate component selection mode.
...
<Step title="Choose Component Depth">
  When you click a component, VibeX shows a hierarchy of components from innermost to outermost. Select the appropriate level for your feedback:
...
- [Configuration & Customisation](/configuration-customisation/global-settings) - Customise VibeX settings

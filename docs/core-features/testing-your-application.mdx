...
Preview Mode provides an embedded browser experience within Vibe Ultra, allowing you to test and iterate on your web applications without leaving the development environment. This feature eliminates the need to switch between your browser and Vibe Ultra by providing live preview capabilities and precise component selection tools.

**Key Benefits:**
- **Embedded viewing**: See your application running directly in Vibe Ultra
...
<Step title="Install Web Companion">
  For precise component selection, install the `vibe-ultra-web-companion` package in your application.

  <Info>
  **Recommended**: Use the "Install companion automatically" button in the Preview tab to have Vibe Ultra create a task that installs and configures the companion for you.
  ...
  **Manual Installation:**
  ...
  ```bash
  npm install vibe-ultra-web-companion
  ```
  ...
  <Tab title="Create React App">
    ...
    ```jsx
    import { VibeKanbanWebCompanion } from 'vibe-ultra-web-companion';
...
3. **Interact with your app** directly within Vibe Ultra
...
<Step title="Activate Selection Mode">
  Click the floating Vibe Ultra companion button in the bottom-right corner of your application to activate component selection mode.
...
<Step title="Choose Component Depth">
  When you click a component, Vibe Ultra shows a hierarchy of components from innermost to outermost. Select the appropriate level for your feedback:
...
- [Configuration & Customisation](/configuration-customisation/global-settings) - Customise Vibe Ultra settings

...
description: "Complete guide to using the Vibe Ultra extension with VSCode, Cursor, and Windsurf"
---

The Vibe Ultra VSCode extension brings task management directly into your IDE, providing seamless integration with logs, diffs, and process monitoring. This extension works with VSCode and popular forks including Cursor and Windsurf.
...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=bloop.vibe-ultra">
  Install the official Vibe Ultra extension for VSCode
</Card>

Alternatively, search for the extension ID in VSCode:
1. Open VSCode
2. Press `Ctrl+Shift+X` (Windows/Linux) or `Cmd+Shift+X` (macOS) to open Extensions
3. Search for `@id:bloop.vibe-ultra`
4. Click **Install**
</Tab>
...
<Card title="Open VSX Registry" icon="download" href="https://open-vsx.org/extension/bloop/vibe-ultra">
...
<Steps>
<Step title="Start a task in Vibe Ultra">
...
<Step title="Launch IDE integration">
  ...
  <Note>
  The button text will reflect your editor choice configured in Vibe Ultra settings.
  </Note>
</Step>
...
**Solution**: Ensure you're working within a worktree created by a Vibe Ultra task.

<Warning>
The extension can only display task information when VSCode is opened in a directory that corresponds to an active Vibe Ultra task worktree.
</Warning>

**Steps to resolve**:
1. Verify you opened VSCode through the "Open in [IDE]" button from a Vibe Ultra task
...
**Problem**: The Vibe Ultra extension doesn't appear in your IDE.

**Solutions**:
- Verify the extension is installed by searching `@id:bloop.vibe-ultra` in Extensions
...
<Tip>
**Workflow Optimization**: Always start tasks from the Vibe Ultra web interface before opening in your IDE to ensure proper context and worktree setup.
</Tip>
...
<Info>
The extension is designed to work with any VSCode-compatible editor. If you're using a different VSCode fork, try installing from Open VSX Registry using the extension ID `bloop.vibe-ultra`.
</Info>

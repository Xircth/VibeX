...
description: "Complete guide to using the VibeX extension with VSCode, Cursor, and Windsurf"
---

The VibeX VSCode extension brings task management directly into your IDE, providing seamless integration with logs, diffs, and process monitoring. This extension works with VSCode and popular forks including Cursor and Windsurf.
...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=bloop.vibex">
  Install the official VibeX extension for VSCode
</Card>

Alternatively, search for the extension ID in VSCode:
1. Open VSCode
2. Press `Ctrl+Shift+X` (Windows/Linux) or `Cmd+Shift+X` (macOS) to open Extensions
3. Search for `@id:bloop.vibex`
4. Click **Install**
</Tab>
...
<Card title="Open VSX Registry" icon="download" href="https://open-vsx.org/extension/bloop/vibex">
...
<Steps>
<Step title="Start a task in VibeX">
...
<Step title="Launch IDE integration">
  ...
  <Note>
  The button text will reflect your editor choice configured in VibeX settings.
  </Note>
</Step>
...
**Solution**: Ensure you're working within a worktree created by a VibeX task.

<Warning>
The extension can only display task information when VSCode is opened in a directory that corresponds to an active VibeX task worktree.
</Warning>

**Steps to resolve**:
1. Verify you opened VSCode through the "Open in [IDE]" button from a VibeX task
...
**Problem**: The VibeX extension doesn't appear in your IDE.

**Solutions**:
- Verify the extension is installed by searching `@id:bloop.vibex` in Extensions
...
<Tip>
**Workflow Optimization**: Always start tasks from the VibeX web interface before opening in your IDE to ensure proper context and worktree setup.
</Tip>
...
<Info>
The extension is designed to work with any VSCode-compatible editor. If you're using a different VSCode fork, try installing from Open VSX Registry using the extension ID `bloop.vibex`.
</Info>

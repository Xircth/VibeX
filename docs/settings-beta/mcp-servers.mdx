...
description: "Configure MCP (Model Context Protocol) servers to enhance your coding agents within Vibe Ultra with additional tools and capabilities."
---
...
<Note>
This page covers configuring MCP servers **within** Vibe Ultra for your coding agents. For connecting external MCP clients to Vibe Ultra's MCP server, see the [Vibe Ultra MCP Server](/integrations/vibe-ultra-mcp-server) guide.
</Note>
...
Vibe Ultra provides one-click installation for popular MCP servers. Click a card to insert a pre-configured MCP server into the JSON configuration.

<Frame>
<img src="/images/settings-beta-popular-mcp-servers.png" alt="Popular MCP servers including Vibe Ultra, Context7, Playwright, Exa, Chrome DevTools, and Dev Manager" />
</Frame>
...
<Check>
These changes update the global configuration file of the coding agent and will persist even if you stop using Vibe Ultra.
</Check>
</Step>
</Steps>

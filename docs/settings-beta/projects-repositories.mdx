...
<Tip>
The dev server must output its URL (e.g., `http://localhost:3000`) to stdout for Vibe Ultra to detect and display it in the preview panel.
</Tip>
...
Run your scripts manually in a terminal before configuring them in Vibe Ultra to ensure they work correctly.
</Accordion>
</AccordionGroup>

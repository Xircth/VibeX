...
- [ ] Task: Remove old live-agent ownership from the target architecture.
...
- [ ] Task: Add `crates/agents` to the workspace as the only live agent runtime.
...
- [ ] Task: Replace Tauri command surface.
...
- [ ] Task: Replace frontend agent workbench.
...
- [ ] Task: Delete old runtime modules and generated types.

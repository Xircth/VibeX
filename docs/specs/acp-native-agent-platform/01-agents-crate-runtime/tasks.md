...
- [ ] Task: Create crate scaffold and workspace dependency.
...
- [ ] Task: Implement runtime identifiers and state models.
...
- [ ] Task: Implement ACP connection manager with fake transport tests.
...
- [ ] Task: Implement cancellation and prompt queue ownership.
...
- [ ] Task: Implement host request bridges.

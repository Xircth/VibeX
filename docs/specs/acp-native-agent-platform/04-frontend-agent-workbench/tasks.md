...
- [ ] Task: Add frontend agent API client and event subscription.
...
- [ ] Task: Add agent state store and event reducers.
...
- [ ] Task: Replace composer submit path.
...
- [ ] Task: Replace transcript rendering.

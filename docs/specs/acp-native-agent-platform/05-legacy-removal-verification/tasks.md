...
- [ ] Task: Delete provider runtime backend.
...
- [ ] Task: Delete provider runtime frontend.
...
- [ ] Task: Delete SDK bridge scripts and package dependencies.
...
- [ ] Task: Remove old ACP executor runtime.
...
- [ ] Task: Replace tests and generated types.

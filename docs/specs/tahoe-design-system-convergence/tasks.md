...
- [ ] Task T1.1: Make `DESIGN.md` the single current design authority.
...
- [ ] Task T1.2: Add Tahoe token aliases and global accessibility fallbacks.
...
- [ ] Task T1.3: Clarify legacy naming transition.
...
- [ ] Task T2.1: Migrate compact control primitives.
...
- [ ] Task T2.2: Migrate overlay primitives.
...
- [ ] Task T3.1: Migrate Settings shell and Windows chrome.
...
- [ ] Task T3.2: Migrate core Settings pages.
...
- [ ] Task T3.3: Migrate agent Settings pages.
...
- [ ] Task T3.4: Migrate MCP and Skills settings.
...
- [ ] Task T4.1: Align workspace topbar, project rail, search palette, menus,
      and desktop toasts.
...
- [ ] Task T5.1: Alias conversation styles to Tahoe tokens.
...
- [ ] Task T5.2: Alias file tree styles to Tahoe tokens.
...
- [ ] Task T5.3: Alias diff styles to Tahoe syntax/diff tokens.
...
- [ ] Task T6.1: Migrate kanban and session hub surfaces.
...
- [ ] Task T6.2: Migrate git, task preview, terminal, and miscellaneous

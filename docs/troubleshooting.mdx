...
description: "Common issues and solutions when using Vibe Ultra"
---
...
If you encounter irrecoverable errors and need to completely wipe your Vibe Ultra database, you can delete the application data directory for your operating system. 
...
<Tab title="macOS">
```bash
~/Library/Application Support/ai.bloop.vibe-ultra/
```
</Tab>

<Tab title="Linux">
```bash
~/.local/share/vibe-ultra/
```
</Tab>

<Tab title="Windows">
```
%APPDATA%\bloop\vibe-ultra\
```

Typically: `C:\Users\<username>\AppData\Roaming\bloop\vibe-ultra\`
</Tab>
</Tabs>

After deleting the application data directory, restart Vibe Ultra to reset with an empty database and default settings.

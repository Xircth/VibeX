...
description: "Common issues and solutions when using VibeX"
---
...
If you encounter irrecoverable errors and need to completely wipe your VibeX database, you can delete the application data directory for your operating system. 
...
<Tab title="macOS">
```bash
~/Library/Application Support/ai.bloop.vibex/
```
</Tab>
...
Typically: `C:\Users\<username>\AppData\Roaming\bloop\vibex\`
</Tab>
</Tabs>

After deleting the application data directory, restart VibeX to reset with an empty database and default settings.

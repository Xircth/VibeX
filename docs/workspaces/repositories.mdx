...
When you add a repository to a workspace, VibeX creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.vibex-workspaces` directory (configurable in Settings).
</Accordion>

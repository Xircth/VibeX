...
When you add a repository to a workspace, Vibe Ultra creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.vibe-ultra-workspaces` directory (configurable in Settings).
</Accordion>

...
export function AgentMark({ id, title }: { id: string; title?: string }) {
  const gid = useId();
  switch (id) {
    case 'claude':
      return (
    ...
    case 'grok':
      return (
        ...
        >
          ...
          <path
            fill="#71757e"
            d="m210.484 312.759 132.981-102.376c6.519-5.019 15.837-3.061 18.943 4.734 16.35 41.114 9.046 90.523-23.483 124.446-32.528 33.924-77.788 41.364-119.157 24.42l-45.191 21.82c64.817 46.205 143.527 34.778 192.712-16.552 39.014-40.687 51.097-96.147 39.799-146.16l.102.107c-16.383-73.472 4.028-102.839 45.84-162.891.99-1.424 1.98-2.848 2.97-4.307l-55.022 57.382v-.178l-190.528 199.59"
          />
          <path
            fill="#71757e"
            d="M183.042 337.641c-46.523-46.347-38.502-118.074 1.194-159.438 29.354-30.613 77.447-43.107 119.43-24.739l45.089-21.714c-8.123-6.123-18.534-12.708-30.48-17.336-53.998-23.173-118.645-11.64-162.54 34.102-42.222 44.033-55.499 111.738-32.699 169.511 17.033 43.179-10.888 73.721-39.013 104.548C74.056 433.503 64.055 444.431 56 456l127.007-118.323"
          />
        </svg>
      );
    case 'cursor':
    ...
    case 'pi':
      return (
        <svg viewBox="0 0 16 16" className="h-full w-full" aria-hidden={!title}>
          ...
          />
          <path
            d="M11.7692 7.46154H15V15H11.7692V7.46154Z"
            fill="currentColor"
          />
        </svg>
      );
    case 'kimi':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          {title ? <title>{title}</title> : null}
          <rect width="24" height="24" rx="5.3" fill="#050505" />
          <path
            d="M7.2 6.5v11M7.2 12l7-5.3M7.2 12l7.6 5.5"
            fill="none"
            stroke="#fff"
            strokeLinecap="round"
    ...
    case 'openclaw':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          {title ? <title>{title}</title> : null}
          <defs>
            <linearGradient id={gid} x1="0" x2="24" y1="2" y2="23">
          ...
          />
          <circle cx="8.835" cy="7.843" r="1.266" fill="#08090c" />
          <circle cx="15.165" cy="7.843" r="1.266" fill="#08090c" />
          <circle cx="9.046" cy="7.632" r=".527" fill="#00e5cc" />
          <circle cx="15.376" cy="7.632" r=".527" fill="#00e5cc" />
        </svg>
      );
    case 'cline':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          />
          <circle cx="12.054" cy="2.779" r="2.779" fill="currentColor" />
        </svg>
      );
    case 'codebuddy':
      return (
        <svg viewBox="0 0 20 20" className="h-full w-full" aria-hidden={!title}>
          {title ? <title>{title}</title> : null}
          <path
            fill="currentColor"
    ...
    case 'hermes':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          {title ? <title>{title}</title> : null}
          <path fill="currentColor" d="M6 4h3v7h6V4h3v16h-3v-6H9v6H6V4z" />
        </svg>
      );
    case 'deepseek':
      return (
        <svg viewBox="0 0 50 50" className="h-full w-full" aria-hidden={!title}>
          {title ? <title>{title}</title> : null}
          <path
            fill="currentColor"
    ...
    case 'copilot':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            fill="currentColor"
            d="M12 2.8 20 7.4v9.2L12 21.2 4 16.6V7.4L12 2.8Zm0 2.5L6.2 8.6v6.8L12 18.7l5.8-3.3V8.6L12 5.3ZM9 10.1a1.2 1.2 0 1 1 0 2.4 1.2 1.2 0 0 1 0-2.4Zm6 0a1.2 1.2 0 1 1 0 2.4 1.2 1.2 0 0 1 0-2.4Z"
          />
        </svg>
      );
    case 'qwen':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            fill="currentColor"
            d="M12 3.2 14.6 9.4 21 12 14.6 14.6 12 20.8 9.4 14.6 3 12 9.4 9.4 12 3.2Zm0 5.3L11 11 8.5 12 11 13l1 2.7 1-2.7 2.5-1L13 11l-1-2.5Z"
          />
        </svg>
      );
    case 'auggie':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            fill="currentColor"
            d="M12 3 20 21h-3.1l-1.5-3.5H8.6L7.1 21H4L12 3Zm0 6.2-2.4 5.5h4.8L12 9.2Z"
          />
        </svg>
      );
    case 'amp':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            fill="currentColor"
            d="M13.2 2 6 13.2h5.1L9.4 22 20 9.6h-5.4L13.2 2Z"
          />
        </svg>
      );
    case 'droid':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <rect
            ...
            strokeWidth="1.8"
          />
          <circle cx="9.2" cy="13" r="1.3" fill="currentColor" />
          <circle cx="14.8" cy="13" r="1.3" fill="currentColor" />
          <path
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
    ...
    case 'goose':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            fill="currentColor"
            d="M14.5 4.2c-2.4 0-4.3 1.7-4.6 3.9C6.8 8.6 4.5 11 4.5 14.2c0 3.4 2.9 5.8 7.2 5.8 4.8 0 7.8-2.7 7.8-6.4 0-2.5-1.4-4.3-3.4-5.2.4-1.2 0-2.6-1.6-3.4-.6-.3-1.2-.8-1.2-.8S14.9 4.2 14.5 4.2Zm.3 2.3c.9 0 1.6.7 1.6 1.5S15.7 9.5 14.8 9.5 13.2 8.8 13.2 8c0-.8.7-1.5 1.6-1.5Z"
          />
        </svg>
      );
    case 'roo':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            fill="currentColor"
            d="M7 4h6.4c2.7 0 4.6 1.8 4.6 4.3 0 1.9-1 3.2-2.6 3.8L18.8 20h-3.3l-3.1-7.2H10.2V20H7V4Zm3.2 3v3.4h3c1.2 0 1.9-.7 1.9-1.7S14.4 7 13.2 7h-3Z"
          />
        </svg>
      );
    case 'continue':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <circle
            ...
            strokeWidth="1.8"
          />
          <path fill="currentColor" d="M10 8.2 16.2 12 10 15.8V8.2Z" />
        </svg>
      );
    case 'aider':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            ...
            strokeWidth="1.8"
            strokeLinecap="round"
            d="M7 19V8.5m0 0a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Zm0 0c6 0 6 6 10 6m0 0a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5Z"
          />
        </svg>
      );
    case 'openhands':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            ...
            strokeWidth="1.8"
            strokeLinecap="round"
            d="M7.2 14.5c-2.2-1.4-2.8-3.8-1.4-5.6S9.7 6.7 11.4 8.2M16.8 14.5c2.2-1.4 2.8-3.8 1.4-5.6S14.3 6.7 12.6 8.2M8.4 16.8c1.1 1.8 3.1 2.7 5.6 1.8"
          />
        </svg>
      );
    case 'amazonq':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            ...
            stroke="currentColor"
            strokeWidth="1.8"
            d="M12 5.2a6.8 6.8 0 1 1 0 13.6 6.8 6.8 0 0 1 0-13.6Z"
          />
          <path
            fill="none"
            stroke="currentColor"
    ...
    case 'crush':
      return (
        <svg viewBox="0 0 24 24" className="h-full w-full" aria-hidden={!title}>
          ...
          <path
            fill="currentColor"
            d="M12 2.4 13.6 9.2 20.8 12 13.6 14.8 12 21.6 10.4 14.8 3.2 12 10.4 9.2 12 2.4Z"
          />
        </svg>
      );
    default:
      return (
        <svg viewBox="0 0 32 32" className="h-full w-full" aria-hidden={!title}>
          {title ? <title>{title}</title> : null}
          <text
            x="16"
            y="21"

export const COMPANION_INSTALL_TASK_TITLE =
  'Install and integrate VibeX Web Companion';

export const COMPANION_INSTALL_TASK_DESCRIPTION = `Goal: Install and integrate the vibex-web-companion package so it renders at the app root in development.
...
3) Integrate the component:
   import { VibeXWebCompanion } from 'vibex-web-companion';
   - Vite/CRA: render <VibeXWebCompanion /> at the app root.
...
Acceptance:
- vibex-web-companion is installed in the correct package.

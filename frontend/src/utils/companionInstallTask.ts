export const COMPANION_INSTALL_TASK_TITLE =
  'Install and integrate VibeUltra Web Companion';

export const COMPANION_INSTALL_TASK_DESCRIPTION = `Goal: Install and integrate the vibe-ultra-web-companion package so it renders at the app root in development.

Do:
1) Detect package manager from lockfiles and use it:
   - pnpm-lock.yaml → pnpm add vibe-ultra-web-companion
   - yarn.lock → yarn add vibe-ultra-web-companion
   - package-lock.json → npm i vibe-ultra-web-companion
   - bun.lockb → bun add vibe-ultra-web-companion
...
3) Integrate the component:
   import { VibeUltraWebCompanion } from 'vibe-ultra-web-companion';
   - Vite/CRA: render <VibeUltraWebCompanion /> at the app root.
...
Acceptance:
- vibe-ultra-web-companion is installed in the correct package.

export declare const PLUGIN_TEMPLATES: readonly ["skill", "mcp", "file-tab", "editor-tab", "full", "ts-worker", "node-worker", "python-worker", "rust-worker", "host-service", "host-chrome", "provider-import", "provider-catalog", "hooks", "panel", "kanban-view"];

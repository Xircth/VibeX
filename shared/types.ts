...
export type AgentAuthModeView = { agent_id: AgentId, mode: string, modes: Array<string>, options: Array<AgentAuthModeOptionView>, credential_env: string, credential_present: boolean, };

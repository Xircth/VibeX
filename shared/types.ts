...
export type Config = { config_version: string, theme: ThemeMode, executor_profile: ExecutorProfileId, disclaimer_acknowledged: boolean, onboarding_acknowledged: boolean, notifications: NotificationConfig, editor: EditorConfig, github: GitHubConfig, workspace_dir: string | null, last_app_version: string | null, show_release_notes: boolean, language: UiLanguage, git_branch_prefix: string, pr_auto_description_enabled: boolean, pr_auto_description_prompt: string | null, pr_auto_description_agent_id: string, pr_auto_description_mode: string | null, pr_auto_description_session_config: { [key in string]?: string }, commit_reminder_enabled: boolean, commit_reminder_mode: CommitReminderMode, commit_reminder_line_threshold: number, send_message_shortcut: SendMessageShortcut, prompt_enhancement_enabled: boolean, prompt_enhancement_model: string, prompt_enhancement_agent_id: string, prompt_enhancement_mode: string | null, prompt_enhancement_session_config: { [key in string]?: string }, prompt_enhancement_prompt: string | null,
/**
 * Opt-in: show the compact-context action in the session input box.
 */
compact_context_enabled: boolean, default_terminal_shell: string | null, files_changed_default_collapsed: boolean, ai_message_default_collapsed: boolean,
/**
...
export type AgentPermissionResponse = { "kind": "selected", option_id: string,
/**
 ...
 */
persist?: boolean, } | { "kind": "cancelled" };
 ...
 */
delivery_channel: DeliveryChannel, terminal: boolean, additional_directories: boolean, filesystem_requests: boolean,
/**
...
export type ConversationEvent = { "kind": "conversation_created", title: string | null, } | { "kind": "conversation_input", event: ConversationInputEvent, } | { "kind": "conversation_steering", event: ConversationSteeringEvent, } | { "kind": "delivery_channel_latched", from: DeliveryChannel, to: DeliveryChannel, } | { "kind": "user_submitted_feedback", note_id: string, operation_id: string, text: string, turn_id: string | null, } | { "kind": "user_feedback_delivered", note_id: string, delivered_at: string, } | { "kind": "user_feedback_expired", note_id: string, } | { "kind": "user_feedback_salvaged", note_id: string, input_id: string, operation_id: string, } | { "kind": "user_feedback_dismissed", note_id: string, operation_id: string, } | { "kind": "conversation_relation_created", relation_id: string, parent_conversation_id: string, child_conversation_id: string, relation_kind: ConversationRelationKind, visibility: ConversationRelationVisibility, metadata: JsonValue, } | { "kind": "agent_binding_started", agent_id: AgentId, working_dir: string, } | { "kind": "agent_binding_ready", acp_session_id: string, capabilities: AcpCapabilitySnapshot, } | { "kind": "agent_binding_recovered", strategy: SessionRecoveryStrategy,
/**
...
export type ConversationTimelineRow = { "kind": "message_turn", turn: MessageTurn, phase: string, fork_point_status?: ForkPointStatus | null, } | { "kind": "permission_request", request: ConversationPermissionView, } | { "kind": "question_request", request: ConversationQuestionRequest,
/**
...
export type SessionLoadFailureReason = { "kind": "resource_not_found" } | { "kind": "authentication_required", message: string, } | { "kind": "unsupported" } | { "kind": "session_archived", recovery_command?: string | null, } | { "kind": "session_busy" } | { "kind": "session_unavailable" } | { "kind": "other", message: string, };
...
export type ConversationForkResult = { conversationId: string, importedEventCount: number, projectionVersion: number, continuity: ConversationForkContinuity, continuityNote?: string | null, parentConversationId: string, };
...
export type DeliveryChannel = "none" | "native" | "pull";

export type ForkPointStatus = "named" | "unnamed" | "tail" | "unsupported";

...
pub fn run(cef_bootstrap: Result<CefBootstrap, String>) {
    ...
    .invoke_handler(tauri::generate_handler![
        ...
        commands::workspaces::continue_conflicts_workspace,
        commands::workspaces::get_workspace_conflict_file,
        commands::workspaces::write_workspace_conflict_resolution,
        ...
        commands::agent_management::pi_plugins,
        commands::agent_management::pi_plugin_add,
        commands::agent_management::pi_plugin_remove,
